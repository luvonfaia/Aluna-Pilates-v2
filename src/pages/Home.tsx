            ...
            <div className="overflow-hidden">
                ...
                <section className="relative h-screen flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                        ...
                        >
                            <Link to="/classes" className="btn-primary-light">
                                {t('home.hero.cta')}
                            </Link>
                    ...
                    <motion.div
                        ...
                        className="absolute bottom-28 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-3"
                        aria-hidden="true"
                    >
                        <span className="text-white/40 uppercase tracking-[0.35em] text-[9px]">Scroll</span>
                        <motion.div
                            animate={{ scaleY: [1, 1.4, 1], opacity: [0.5, 0.9, 0.5] }}
                            transition={{ duration: 1.8, repeat: Infinity, ease: "easeInOut" }}
                            className="w-px h-10 bg-gradient-to-b from-white/60 to-transparent origin-top"
                        />
                    </motion.div>
                </section>
                ...
                <section className="py-32 bg-aluna-cream">
                    <div className="max-w-7xl mx-auto px-6 lg:px-12">
                        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
                            ...
                            <Link
                                to="/classes"
                                className="hidden md:flex items-center gap-2 text-aluna-charcoal hover:text-aluna-gold uppercase tracking-widest text-[10px] border-b border-aluna-charcoal/40 hover:border-aluna-gold pb-1 transition-all duration-300 mt-6"
                            >
                ...
                <section className="flex flex-col md:flex-row h-auto md:h-[700px]">
                    ...
                    <div className="w-full md:w-1/2 bg-aluna-charcoal text-aluna-alabaster p-12 md:p-20 xl:p-28 flex flex-col justify-center">
                        ...
                        >
                            ...
                            <Link
                                to="/about"
                                className="btn-secondary border-aluna-gold/40 text-aluna-alabaster hover:bg-aluna-gold/15 hover:border-aluna-gold/70 transition-all duration-300"
                            >
                                {t('home.spotlight.cta')}
                            </Link>
                        </motion.div>
