...
export default function FloatingCTA({ cookieBannerVisible = false, menuOpen = false }: { cookieBannerVisible?: boolean; menuOpen?: boolean }) {
    ...
    return (
        ...
        >
            <div
                className={`flex items-center gap-2 p-2 rounded-[60px] transition-all duration-500 ${outerClass}`}
            ...
            >
                ...
                <a
                    ...
                    aria-label="Call us"
                    className={`relative h-11 px-5 sm:px-4 lg:px-5 rounded-full overflow-hidden flex items-center justify-center gap-0 sm:gap-2 lg:gap-2.5 cursor-pointer transition-colors duration-500 ${innerClass}`}
